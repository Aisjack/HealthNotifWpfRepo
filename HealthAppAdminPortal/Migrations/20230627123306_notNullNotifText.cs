...
{
    /// <inheritdoc />
    public partial class notNullNotifText : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NotificationUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    UrlActive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
